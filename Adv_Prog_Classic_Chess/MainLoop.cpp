...
int startGame(SDL_BaseHandler* m_handler)
{
    ...
    Mix_Chunk* move_1 = Mix_LoadWAV("move.wav");

    Mix_Chunk* move_2 = Mix_LoadWAV("move2.wav");
...
void runGameLoop()
{
    ...
    Mix_Chunk* buttonclink = Mix_LoadWAV("buttonclick.wav");
    ...
    while(!quit)
    {
        while(SDL_PollEvent(&e) != 0)
        {
            ...
            else
            {
                ...
                {
                    // << 1 << '\n';
                    Mix_PlayChannel(-1, buttonclink, 0);
                }
